...
#define EASY_PDK_INIT_SYSCLOCK_8MHZ()       {EASY_PDK_FUSE(FUSE_SECURITY_OFF|FUSE_LVR_3V|FUSE_IO_DRV_NORMAL|FUSE_BOOTUP_FAST);_clkmd=CLKMD_ENABLE_ILRC|CLKMD_ENABLE_IHRC|CLKMD_IHRC_DIV2;}
#define EASY_PDK_INIT_SYSCLOCK_4MHZ()       {EASY_PDK_FUSE(FUSE_SECURITY_OFF|FUSE_LVR_2V2|FUSE_IO_DRV_NORMAL|FUSE_BOOTUP_FAST);_clkmd=CLKMD_ENABLE_ILRC|CLKMD_ENABLE_IHRC|CLKMD_IHRC_DIV4;}
#define EASY_PDK_INIT_SYSCLOCK_2MHZ()       {EASY_PDK_FUSE(FUSE_SECURITY_OFF|FUSE_LVR_2V|FUSE_IO_DRV_NORMAL|FUSE_BOOTUP_FAST);_clkmd=CLKMD_ENABLE_ILRC|CLKMD_ENABLE_IHRC|CLKMD_IHRC_DIV8;}
